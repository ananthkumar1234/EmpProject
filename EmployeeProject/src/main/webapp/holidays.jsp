...
<% } 
else if (request.getAttribute("msg")!=null && request.getAttribute("msg").equals("Inserted")){%> 
showMessage('success', 'Holiday Inserted Successfully ....');
<%}
else if (request.getAttribute("msg")!=null && request.getAttribute("msg").equals("Deleted")){%> 
showMessage('error', 'Holiday Deleted Successfully ...');
<%}%>}
